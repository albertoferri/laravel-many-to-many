...
@section('content')
    <div class="container py-5">
        <div class="row mb-5">
            <div class="card mb-3">
                <div class="card-body">
                  <h5 class="card-title text-capitalize">{{$technology->title}}</h5>
                  <p class="card-text">colore: {{$technology->color}}</p>
                  <div class="d-flex justify-content-between">
                      <a href="{{route('technologies.edit', $technology->id)}}" class="btn btn-warning fw-bold text-uppercase">opzioni</a>
